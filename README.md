...
To convert an already existing extension/userscript into an addon (or a new addon!) is very easy: [Check out the guide](https://github.com/ScratchAddons/ScratchAddons/wiki/Creating-an-addon).
