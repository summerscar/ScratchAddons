export default async function ({ addon, global, console }) {
  // https://github.com/LLK/scratch-blocks/compare/hotfix/totally-normal-2021
  ...
  // const oldMetrics = Blockly.BlockSvg.metricsAreEquivalent_;
  // Blockly.BlockSvg.metricsAreEquivalent_ = function (...params) {
  //   console.log("TEST AHHHHHHH");
  //   oldMetrics.call(Blockly.BlockSvg, ...params);
  // };
  const oldBlockSvg = Blockly.BlockSvg;
  Blockly.BlockSvg = function (...params) {};
  ...
  const oldRenderDraw = Blockly.BlockSvg.prototype.renderDraw_;
  Blockly.BlockSvg.prototype.renderDraw_ = function (...params) {
    this.initCatStuff();
    oldRenderDraw.call(this, ...params);
    // if (this.startHat_ && !this.svgFace_.firstChild) {
    //   this.renderCatFace_();
    // }
  };
  addon.tab.traps.vm.emitTargetsUpdate();
  Blockly.getMainWorkspace().getFlyout().getWorkspace().render();
